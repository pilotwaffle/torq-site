...
const baseFeatures = [
  'All workspaces: Advisory, Market, Docs, Draft, Runs, Cyber Range, Chat fallback',
  'TORQ AI / Prince Flowers — routed through L27',
  'Dream Memory + T63 unified semantic memory',
  'Live quotes, chart vision, and gated web search',
  'PDF, DOCX, Markdown, and Slack export',
  'L17–L28 governance: risk, enforcement, audit',
  'Up to 300 queries/month included',
  'Priority support',
  'Early-access rate lock — base price not raised on this plan',
];
    ...
    <section id="pricing" className="py-28 bg-torq-darker relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-torq-red text-xs font-bold tracking-[0.2em] uppercase mb-4">Pricing</p>
          ...
          <p className="text-torq-grey max-w-lg mx-auto text-lg">
            $50/month gets you the workbench. Heavy users pay a fair overage — light users are not subsidizing power users.
          </p>
        </div>
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="relative bg-torq-surface border border-torq-red/20 rounded-2xl p-8">
              <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-torq-red/15 border border-torq-red/30 text-torq-red text-[10px] font-bold tracking-widest uppercase w-fit mb-6">
                <Zap size={10} />
                Early access — rate locked on the base plan
              </div>
              ...
              <a
                ...
                className="block w-full text-center py-4 px-8 rounded-xl bg-torq-red hover:bg-torq-red-bright text-white font-bold text-lg transition-all duration-200 glow-red"
              >
                Start Free Trial
              </a>
            </div>
          ...
          <div className="flex flex-col gap-5">
            <div className="rounded-2xl bg-torq-surface border border-torq-border p-6">
              ...
              <p className="text-torq-grey text-sm leading-relaxed mb-4">
                The $50 base plan covers up to <span className="text-torq-white font-semibold">300 queries/month</span> — enough for most operators.
              </p>
              <div className="p-3 rounded-lg bg-torq-black/60 border border-torq-border">
                <p className="text-xs text-torq-grey leading-relaxed">
                  <span className="text-torq-white font-semibold">Overages billed at $0.15 per query above 300.</span> Early access users stay on the locked base rate.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-torq-surface border border-torq-border p-6 opacity-80">
              ...
              <p className="text-torq-grey text-sm leading-relaxed mb-4">
                Unlimited queries, team seats, API access, custom memory configurations, and dedicated support.
              </p>
              <a
                href="mailto:Admin@TorqBusinessSolutions.com?subject=TORQ Console Pro Waitlist&body=Hi, I'd like to join the Pro plan waitlist for TORQ Console."
            ...
            <div className="rounded-2xl bg-torq-surface border border-torq-border p-5">
              <ul className="space-y-2">
                {[
                  ...
                  'Cancel anytime',
                  'Full workbench from day one',
                  'Costs stay visible — $50 + $0.15 overage',
                ].map((item, i) => (
